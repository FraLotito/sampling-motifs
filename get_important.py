...
socio_1 = ['workplace', 'hs', 'ps', 'hospital', 'babbuini', 'justice', 'wiki', 'enron', 'EU', 'conference']
collab_1 = ['dblp', 'history', 'geology', 'gene', 'ndcclasses', 'ndcsub']
bio = ['gene', 'ndcclasses', 'ndcsub']
tech = ['enron', 'EU']
socio = ['workplace', 'hs', 'ps', 'hospital', 'babbuini', 'justice', 'wiki','conference']
collab = ['dblp', 'history', 'geology']
...
domains = ['SOCIO', 'COLLAB', 'BIO', 'TECH']
res = []
for d in domains:
    res.append(print_domain(d))
#print_PACS()
average = {}
print("--- OVERALL ---")
for k in res[0]:
    average[k] = (res[0][k] + res[1][k]) / 2
