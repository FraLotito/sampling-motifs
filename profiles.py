...
datasets = ['gene', 'ndcclasses', 'ndcsub', 'workplace', 'ps', 'hs', 'hospital', 'justice', 'wiki', 'conference', 'baboons', 'enron', 'EU', 'dblp', 'history', 'geology']
...
for k in data.keys():
    ...
    sn.despine()
    plt.savefig("profile_{}_separated.pdf".format(k))
    i+=1
